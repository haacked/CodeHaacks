...
[assembly: PreApplicationStartMethod(typeof(AuthenticationRedirectFixupModule), "Register")]
namespace AspNetHaack {
    public class AuthenticationRedirectFixupModule : IHttpModule {
        ...
        public static void Register() {
            DynamicModuleUtility.RegisterModule(typeof(AuthenticationRedirectFixupModule));
        }
    }
}
